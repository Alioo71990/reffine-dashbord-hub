...
const LANG_NAMES: Record<string, string> = {
  en: 'English', az: 'Azerbaijani', ka: 'Georgian', kk: 'Kazakh',
  ru: 'Russian', ar: 'Arabic', fr: 'French', hy: 'Armenian',
  'ku-kmr': 'Kurdish (Kurmanji)', 'ku-ckb': 'Kurdish (Sorani)'
}
...
async function callGroq(content: string, fromLang: string, toLang: string, batch: boolean, key: string): Promise<string> {
  ...
  for (const model of GROQ_MODELS) {
    ...
    } catch (e) { console.warn('Model failed:', model, e) }
  }
