...
export interface AdminConfig {
  ...
  groqKey: string
  tasksCsvUrl: string
  offersStatusUrlJag: string
  offersStatusUrlLr: string
...
const DEFAULT_CONFIG: AdminConfig = {
  ...
  offersStatusUrlJag: 'https://docs.google.com/spreadsheets/d/e/2PACX-1vQL1YZ28A08mkRUpCQRvyp9aUDeNwC9tVCtZKH3Benr7Vepik7z8LzdV3qKKMeJiJP_Yfhnep2ynnLq/pub?gid=0&single=true&output=csv',
  offersStatusUrlLr: 'https://docs.google.com/spreadsheets/d/e/2PACX-1vQL1YZ28A08mkRUpCQRvyp9aUDeNwC9tVCtZKH3Benr7Vepik7z8LzdV3qKKMeJiJP_Yfhnep2ynnLq/pub?gid=1&single=true&output=csv',
